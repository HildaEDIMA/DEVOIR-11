...
## Changeons le type d'une variable;
attach(cereales)
...
### fusionnons la base cereales et la base table_de_conversion par la variable real_id;
...
# on a une base prixunitaire dont chque (p,u,t) aura un seul prix p;
# -----------------------------------------------------------------
